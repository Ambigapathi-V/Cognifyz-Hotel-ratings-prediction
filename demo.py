    ...
    def build_model(self):
        try:
            ...
            if len(Y_train.shape) == 1:
                ...
                logging.info("Y_train shape after reshaping: {}".format(Y_train.shape))
            if len(Y_test.shape) == 1:
                Y_test = Y_test.reshape(-1, 1)
                logging.info("Y_test shape after reshaping: {}".format(Y_test.shape))
            ...
            # Optimizer and learning rate schedule (optional)
